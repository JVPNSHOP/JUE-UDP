    ...
    <div class="container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-number" id="server-status">Checking...</div>
            </div>
            <div class="stat-card">
        ...
        <div class="server-info">
            <div class="server-card">
                <div class="server-header">
                    ...
                    <div class="status-badge" id="server-status-badge">Checking...</div>
                </div>
        ...
        function updateDashboard() {
            fetch('online_app.php')
                ...
                .then(data => {
                    ...
                    document.getElementById('online-users').textContent = newCount;
                ...
                .catch(error => {
                    ...
                    document.getElementById('server-status-badge').className = 'status-badge status-error';
...
EOF
    ...
    # Create JSON API endpoint with ACCURATE user counting
...
function getServerUptime() {
    if (function_exists('shell_exec')) {
        $output = shell_exec("systemctl show hysteria-server.service --property=ActiveState --value 2>/dev/null");
        if (trim($output) === 'active') {
            $start_time = shell_exec("systemctl show hysteria-server.service --property=ActiveEnterTimestamp --value 2>/dev/null");
...
EOF
    ...
    # Create Text API endpoint with ACCURATE counting
...
EOF
    ...
    echo "   1. SS command (established state)"
    echo "   2. Netstat fallback"
    echo "   3. Process-specific connections"
    echo "   4. /proc/net/udp analysis"
    echo ""
    echo "=================================================="
}
